...
if __name__ == "__main__":
    ...
    charge1=np.divide(charge1,23.)
    charge4=np.transpose(charge_pairs)[1]
    charge4=np.divide(charge4,23.)

    plt.hist2d(charge1,charge4,bins=[np.arange(0,400,20),np.arange(0,500,20)])
    ...
    plt.savefig('charge_correlation.png')
    #plt.show()
    plt.clf()
    plt.cla()
